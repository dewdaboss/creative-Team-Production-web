...
export const site = {
  ...
  whatsapp: (process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "919876543210").replace(/\D/g, ""),
  ...
  instagram:
    process.env.NEXT_PUBLIC_INSTAGRAM_URL ?? "https://instagram.com/creativeteam.production",
